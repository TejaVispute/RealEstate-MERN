        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <button disabled={loading || uploading} className='p-3 rounded-lg bg-slate-700 text-white hover:opacity-95 disabled:opacity-80'>{loading ? "CREATING..." : "CREATE LISTING"}</button>
